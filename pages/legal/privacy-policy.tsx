...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <p>
        Le site web webkick.ca est détenu par WebKick CA, qui est un contrôleur
        de données de vos données personnelles.
        <br />
        Nous avons adopté cette politique de confidentialité, qui détermine la
        manière dont nous traitons les informations collectées par webkick.ca,
        qui fournit également les raisons pour lesquelles nous devons collecter
        certaines données personnelles vous concernant. Par conséquent, vous
        devez lire cette politique de confidentialité avant d’utiliser le site
        web de webkick.ca. <br />
      ...
      <p>
        Lorsque vous visitez le webkick.ca, nous recueillons automatiquement
        ...
        pages web ou les produits individuels que vous consultez, sur les sites
        web ou les termes de recherche qui vous ont renvoyé au site et sur la
        manière dont vous interagissez avec le site. Nous désignons ces
        informations collectées automatiquement par le terme &quot;informations
        sur les appareils&quot;. En outre, nous pourrions collecter les données
        personnelles que vous nous fournissez (y compris, mais sans s’y limiter,
        le nom, le prénom, l’adresse, les informations de paiement, etc.) lors
        de l’inscription afin de pouvoir exécuter le contrat.
      </p>
      ...
      <p>
        ...
        d’informations, par lesquelles quelqu’un pourrait vous identifier comme
        un individu spécifique et identifiable. Toutefois, si vous souhaitez
        utiliser certaines fonctionnalités du site web, ou si vous souhaitez
        recevoir notre lettre d’information ou fournir d’autres détails en
        ...
        ville de résidence, votre organisation, votre numéro de téléphone. Vous
        pouvez choisir de ne pas nous fournir vos données personnelles, mais il
        se peut alors que vous ne puissiez pas profiter de certaines
        fonctionnalités du site web. Par exemple, vous ne pourrez pas recevoir
        notre bulletin d’information ou nous contacter directement à partir du
        site web. Les utilisateurs qui ne savent pas quelles informations sont
        obligatoires sont invités à nous contacter via webkick.agency@gmail.com.
      </p>
      <h4>Vos droits: </h4>
      <p>
        Si vous êtes un résident européen, vous disposez des droits suivants
        liés à vos données personnelles :<br />
        <ul>
      ...
      <p>
        ...
        pouvez envoyer un courriel à <i>webkick.agency@gmail.com</i>.
      </p>
    </>
  )
}
