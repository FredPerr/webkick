import { formatHexColors } from '@/utils/Color'
import MiniGl from '@/utils/MiniGl'
...
export default class Gradient {
  constructor(colors) {
    ...
    // this.isStatic = o.disableAmbientAnimations()
  ...
  resize() {
    if (window.onresize !== undefined && this.minigl !== undefined) {
  ...
  async connect() {
    ...
    // this.scrollObserver = await new ScrollObserver(0.1, false);
    ...
    //   if (this.conf.playing) this.pause();
    // }),
