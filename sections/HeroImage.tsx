...
function LaptopFrame(props: FrameProps) {
  return (
    <div className={styles.laptop_frame}>
      <Image
        className={`${styles.laptop_frame_img} ${
          props.visisble && styles.current_frame
        }`}
        src={`/images/hero/${props.name}-laptop.jpg`}
        alt={props.name}
        width={2880}
        height={1600}
      />
...
function MobileFrame(props: FrameProps) {
  return (
    <div className={styles.mobile_frame}>
      <Image
        className={`${styles.mobile_frame_img} ${
          props.visisble && styles.current_frame
        }`}
        src={`/images/hero/${props.name}-mobile.jpg`}
        alt={props.name}
        width={780}
        height={1688}
      />
